...
const findFileFromName = (bundle, name) =>
  Object.values(bundle).find((desc) => (desc.name || '') === name);
...
const findChunkWithName = (bundle, name) =>
  Object.values(bundle).find((desc) => (desc.facadeModuleId || '').endsWith(name));
